...
BED_RULES_FILE = os.path.join(BASE_DIR, "rules.bedroom.json")
BATH_RULES_FILE = os.path.join(BASE_DIR, "rules.bathroom.json")
LIV_RULES_FILE = os.path.join(BASE_DIR, "rules.livingroom.json")
KITCH_RULES_FILE = os.path.join(BASE_DIR, "rules.kitchen.json")
